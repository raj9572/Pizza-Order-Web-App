...
export const getPizzaByIdReducer = (state = {},action)=>{
    switch(action.type){
        case 'GET_PIZZAS_Id_REQUEST' :
            return{
                ...state,
                loading:true
            }
        case 'GET_PIZZAS_Id_SUCCESS' : 
        return{
            pizza:action.payload,
            loading:false
        }
        case 'GET_PIZZAS_Id_FAIL' : 
        return{
            error : action.payload,
            loading:false
        }
...
export const updatedPizzaReducer = (state = {},action)=>{
    switch(action.type){
        case 'UPDATE_PIZZAS_Id_REQUEST' :
            return{
                ...state,
                updateloading:true
            }
        case 'UPDATE_PIZZAS_Id_SUCCESS' : 
        return{
            updatesuccess:true,
            updateloading:false
        }
        case 'UPDATE_PIZZAS_Id_FAIL' : 
        return{
            error : action.payload,
            updateloading:false
        }
